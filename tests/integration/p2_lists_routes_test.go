...
func TestP2ListsRoutesPermissionsAndCrossWorkspace(t *testing.T) {
	...
	cases := map[string]listsRouteCase{
		...
		"GET /workloads/:id/runtime-instances":     {path: "/workloads/" + w + "/runtime-instances", perm: read, want: 404},
		"GET /workloads/:id/observed-access":       {path: "/workloads/" + w + "/observed-access", perm: read, want: 404},
		"GET /workloads/:id/runtime-policy-status": {path: "/workloads/" + w + "/runtime-policy-status", perm: read, want: 404},
		...
		"GET /identities/:id/observed-use": {path: "/identities/" + id + "/observed-use", perm: read, want: 404},
