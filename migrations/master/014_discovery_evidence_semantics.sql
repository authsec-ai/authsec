-- 014_discovery_evidence_semantics.sql
--
...
-- No BEGIN/COMMIT here: the runner wraps each file in its own transaction,
-- and a second one ends it early (see 006_discovery_owns_github.sql).
