-- Migration 006: Create workload_entries table for SPIRE workload registration.
...
CREATE TABLE IF NOT EXISTS workload_entries (
    ...
    PRIMARY KEY(id),
    CONSTRAINT fk_workload_entry_tenant FOREIGN KEY(tenant_id) REFERENCES tenants(id)
);
