...
type WorkloadEntryRepository interface {
	...
	GetBySpiffeID(ctx context.Context, workspaceID, spiffeID string) (*models.WorkloadEntry, error)
	...
	ListByParent(ctx context.Context, workspaceID, parentID string) ([]*models.WorkloadEntry, error)
	ClaimUnassignedEntries(ctx context.Context, workspaceID, agentSpiffeID string) (int64, error)
	Update(ctx context.Context, entry *models.WorkloadEntry) error
	Delete(ctx context.Context, id string) error
	FindMatchingEntries(ctx context.Context, workspaceID string, selectors map[string]string) ([]*models.WorkloadEntry, error)
}
