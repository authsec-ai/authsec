...
type AgentRepository interface {
	...
	GetByTenantAndNode(ctx context.Context, workspaceID, nodeID string) (*models.Agent, error)
	Update(ctx context.Context, agent *models.Agent) error
	Delete(ctx context.Context, id string) error
	ListByTenant(ctx context.Context, workspaceID string) ([]*models.Agent, error)
